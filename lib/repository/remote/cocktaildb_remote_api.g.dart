...
part of 'cocktaildb_remote_api.dart';

// **************************************************************************
// RetrofitGenerator
// **************************************************************************

class _CocktailDBRemoteApi implements CocktailDBRemoteApi {
  _CocktailDBRemoteApi(this._dio, {this.baseUrl}) {
  ...
  @override
  Future<CocktailResult> getCocktailById(drinkId) async {
    ArgumentError.checkNotNull(drinkId, 'drinkId');
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'i': drinkId};
    final _data = <String, dynamic>{};
    final _result = await _dio.request<Map<String, dynamic>>('lookup.php',
        queryParameters: queryParameters,
        options: RequestOptions(
            method: 'GET',
            headers: <String, dynamic>{},
